...
class TestLab2CNYT(unittest.TestCase):
    ...
    def test_suma_Matriz(self):
        ...
        self.assertEqual(lab2.suma_Matriz(v1, v2),
                         [[[-15, -5], [-10, -6], [7, 3]], [[4, 17], [6, -7], [14, -10]], [[5, 5], [2, -1], [-2, -1]]])
    ...
    def test_transpuesta_Matriz_Vector(self):
        ...
        self.assertEqual(lab2.transpuesta_Matriz_Vector(v1),
    ...
    def test_Producto_Matriz(self):
        ...
        self.assertEqual(lab2.producto_Matriz(v1, v2),
                         [[[-33, 153], [120, 0], [-44, -22]], [[87, 0], [-26, -117], [107, 70]],
                          [[0, 165], [147, 26], [69, -36]]])
